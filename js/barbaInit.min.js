...
const homeCssFileUrl = `https://cdn.jsdelivr.net/gh/blountdj/portfolio-site@v1/min/css/home.min.css`
const portfolioCssFileUrl = `https://cdn.jsdelivr.net/gh/blountdj/portfolio-site@v1/min/css/portfolio.min.css`
const projectsCssFileUrl = `https://cdn.jsdelivr.net/gh/blountdj/portfolio-site@v1/min/css/project.min-page.css`
const aboutCssFileUrl = `https://cdn.jsdelivr.net/gh/blountdj/portfolio-site@v1/min/css/about.min.css`
const contactCssFileUrl = `https://cdn.jsdelivr.net/gh/blountdj/portfolio-site@v1/min/css/contact.min.css`
