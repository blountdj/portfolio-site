...
let config = {
    ...
    DENSITY_DISSIPATION: 2.2, // 1 is default
    VELOCITY_DISSIPATION: 0.8,
    PRESSURE: 0.28, // 0.8 is default
...
function render(target) {
    ...
    gl.clearColor(0.0, 0.0, 0.0, 0.0); // Ensure this is set every frame
...
// Call this in your main loop or after suspicious operations
checkGLError();